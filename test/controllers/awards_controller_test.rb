...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { description: @award.description, location: @award.location, time: @award.time, title: @award.title }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { description: @award.description, location: @award.location, time: @award.time, title: @award.title }
    assert_redirected_to award_path(assigns(:award))
  end
